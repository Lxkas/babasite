	...
	return (
		<div className="grid grid-cols-12">
			...
			<div className="col-span-7 xl:col-span-9">
				<div className="prose h-screen w-full">
					<h1>How to Meditate</h1>
					<p>
						{`Meditating is easy. Raja Yoga even has the name 'Easy
						Raja Yoga'. But sometimes getting started needs a little
						explanation. Here is a simple five-step process to
						follow. Soon you'll arrive at the quiet still place with
						just a single stride - a single thought - and you won't
						even need to take five steps.`}
					</p>
				</div>
